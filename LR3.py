...
wcat=pd.read_csv(r"C:\Users\smvs4\Desktop\Srinivas\Assignments\Simple linear regression\emp_data.csv")
wcat.columns
wcat
...
model=smf.ols("wcat['Churn_out_rate']~wcat['Salary_hike']",data=wcat).fit()
...
model2 = smf.ols("wcat['Churn_out_rate']~np.log(wcat['Salary_hike'])",data=wcat).fit()
model2.params
model2.summary()
...
model3 = smf.ols("np.log(wcat['Churn_out_rate'])~wcat['Salary_hike']",data=wcat).fit()
model3.params
model3.summary()
...
model_quad = smf.ols("wcat['Churn_out_rate']~wcat['Salary_hike']+wcat['Salary_hike']*wcat['Salary_hike']",data=wcat).fit()
model_quad.params
model_quad.summary()
